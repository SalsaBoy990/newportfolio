...
<div class="card">
    ...
    <div class="card-body">
        <?php
        echo anchor('admin_projects/manage', 'View All Projects', array("class" => "button alt"));
        echo anchor('admin_projects/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array(
                ...
                <div class="row">
                    <div class="full-width">
                        <?php if (isset($cover_image) && $cover_image !== '') { ?>
                            <img class="admin-image-fullwidth" src="<?= BASE_URL.$cover_image ?>" alt="<?= $title ?>">
                        <?php } ?>
                    </div>
                </div>
                <div class="row">
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('admin_projects/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
